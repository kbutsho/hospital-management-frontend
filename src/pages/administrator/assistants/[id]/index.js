...
const AssistantDetails = () => {
    ...
    const fetchData = async (id) => {
        try {
            if (id) {
                ...
                setLoading(true)
                const res = await axios.get(`${config.api}/administrator/assistant/${id}`, {
                    headers: {
    ...
    const formSubmit = async (id) => {
        try {
            if (id) {
                ...
                const res = await axios.post(`${config.api}/administrator/assistant/profile/update/${id}`, data, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
    ...
    const handlePhotoSubmit = async (e) => {
        ...
        try {
            if (id) {
                setAddLoading(true)
                const res = await axios.post(`${config.api}/administrator/assistant/profile/photo/update/${id}`, formDataToSend, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                })
    ...
    const handelDeletePhoto = async () => {
        try {
            if (id) {
                setAddLoading(true);
                const res = await axios.get(`${config.api}/administrator/assistant/profile/photo/delete/${id}`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                })
    ...
    const submitPasswordChange = async () => {
        try {
            if (id) {
                ...
                const res = await axios.post(`${config.api}/administrator/assistant/profile/change-password/${id}`, data, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                })
                                ...
                                <ModalBody>
                                    <div className='p-3'>
                                        ...
                                        <form onSubmit={handlePhotoSubmit} encType='multiple/form-data'>
                                            ...
                                            {
                                                addLoading ?
                                                    <button style={{ borderRadius: "2px" }} disabled className='mt-4 fw-bold w-100 btn btn-primary'>submitting...</button> :
                                                    <input style={{ borderRadius: "2px" }} type="submit" value="submit" className='mt-4 fw-bold w-100 btn btn-primary' />
                                            }
                                        </form>
                                    </div>
                                </ModalBody>
                            ...
                            <Modal isOpen={photoDeleteModal} className="modal-md" onClick={togglePhotoDeleteModal}>
                                ...
                                <ModalFooter>
                                    <div className='d-flex'>
                                        <button style={{ borderRadius: "2px" }} onClick={togglePhotoDeleteModal} className='btn btn-primary btn-sm fw-bold me-2'>close</button>
                                        <button style={{ borderRadius: "2px" }} onClick={handelDeletePhoto} className='btn btn-danger btn-sm fw-bold'>delete</button>
                                    </div>
                                </ModalFooter>
                            </Modal>
                        </div>
...

                                        {
                                            addLoading ?
                                                <button
                                                    style={{ borderRadius: "2px" }}
                                                    disabled
                                                    className='mt-4 fw-bold w-100 btn btn-primary'>submitting...</button> :
                                                <button
                                                    style={{ borderRadius: "2px" }}
                                                    onClick={submitPasswordChange}
                                                    className='mt-4 fw-bold w-100 btn btn-primary'>submit</button>
                                        }
                                    </div>
                                </ModalBody>
                            </Modal>
...
AssistantDetails.getLayout = function getLayout(page) {
