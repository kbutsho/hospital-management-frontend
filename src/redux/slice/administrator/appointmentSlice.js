...
const appointmentSlice = createSlice({
    name: 'administrator_appointments',
    initialState: {
        data: [],
        totalItems: 0,
        fetchedItems: 0,
...
export const { updateAppointmentStatus, resetAppointment, storeAppointment, removeAppointment, totalItemsCount, fetchedItemsCount } = appointmentSlice.actions;
