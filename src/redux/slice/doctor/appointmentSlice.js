...
export const { updateAppointmentStatus, resetAppointment, storeAppointment, removeAppointment, totalItemsCount, fetchedItemsCount } = doctorAppointmentSlice.actions;
