...
const AssistantLayout = ({ children }) => {
    ...
    useEffect(() => {
        authentication(setLoading, router, toastShownRef, ROLE.ASSISTANT);
                        ...
                        <div className="col-sm-5 col-md-4 col-lg-3 col-12 mb-4">
                            <div className='bg-light shadow-sm p-3 rounded-1'>
                                ...
                                <Link href="/assistant/profile"
                                    className={`${styles.sidebarMenu} 
                                    ${isActive('/assistant/profile') ? styles.activeMenu : ''}`}>
                                    <div className={styles.sidebarMenuIcon}>
                                        <BiSolidDashboard />
                                    </div>
                                    <div className={styles.sidebarMenuLink}>
                                ...
                                {/* <Link href="/assistant/doctors"
                                    className={`${styles.sidebarMenu} 
                                    ${isActive('/assistant/doctors') ? styles.activeMenu : ''}`}>
                                    <div className={styles.sidebarMenuIcon}>
                                        <BiSolidDashboard />
                                    </div>
                                    <div className={styles.sidebarMenuLink}>
